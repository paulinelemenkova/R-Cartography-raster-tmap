...
# Elevation data is needed to create a hillshade map. The raster package provides an easy access to the SRTM 90 m resolution elevation data with the getData() function. For example, it is possible to download the elevation data for the whole country of "" using the code below: download the elevation data for the whole country of Lebanon
alt = getData("alt", country = "Lebanon", path = tempdir())
...
# "arrow", "4star", "8star", "radar", "rose"
    tm_layout(scale = .8,
        main.title = "Slope terrain analysis based on DEM of Lebanon. Mapping: R",
...
# plot map
map1
tmap_save(map1, "Lebanon_Slope.jpg", dpi = 300, height = 10)
...
# "arrow", "4star", "8star", "radar", "rose"
    tm_layout(scale = .8,
        main.title = "Aspect terrain analysis based on DEM of Lebanon. Mapping: R",
        main.title.position = "center",
        main.title.color = "black",
        main.title.size = 0.9,
        title = "Aspect \n(W-E-S-N)",
...
# plot map
map2
tmap_save(map2, "Lebanon_Aspect.jpg", dpi = 300, height = 10)

Twomaps <- tmap_arrange(map1, map2)
Twomaps
tmap_save(Twomaps, "Lebanon_SlopeAspect.jpg", dpi = 300, height = 10, width = 15)
...
# plot map
map3
tmap_save(map3, "Lebanon_Hillshade.jpg", height = 10)
...
# plot map
map4
tmap_save(map4, "Lebanon_Elevation.jpg", dpi = 300, height = 10)
