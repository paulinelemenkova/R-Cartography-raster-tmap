...
alt = getData("alt", country = "Jordan", path = tempdir())
...
# "arrow", "4star", "8star", "radar", "rose"
    tm_layout(scale = .8,
        main.title = "Slope terrain analysis based on DEM of Jordan. Mapping: R",
...
# plot map
map1
tmap_save(map1, "Jordan_Slope.jpg", dpi = 300, height = 10)
...
# "arrow", "4star", "8star", "radar", "rose"
    tm_layout(scale = .8,
        main.title = "Aspect terrain analysis based on DEM of Jordan. Mapping: R",
        main.title.position = "center",
        main.title.color = "black",
        main.title.size = 0.9,
...
# plot map
map2
tmap_save(map2, "Jordan_Aspect.jpg", dpi = 300, height = 10)

Twomaps <- tmap_arrange(map1, map2)
Twomaps
tmap_save(Twomaps, "Jordan_SlopeAspect.jpg", dpi = 300, height = 10, width = 15)
...
# "arrow", "4star", "8star", "radar", "rose"
    tm_layout(scale = .9,
        main.title = "Hillshade terrain analysis based on DEM of Jordan. Mapping: R",
        main.title.position = "center",
        main.title.color = "black",
        main.title.size = 1.0,
...
# plot map
map3
tmap_save(map3, "Jordan_Hillshade.jpg", height = 10)
...
# "arrow", "4star", "8star", "radar", "rose"
    tm_layout(scale = .8,
        main.title = "Elevation terrain analysis based on DEM of Jordan. Mapping: R",
        main.title.position = "center",
        main.title.color = "black",
        main.title.size = 1.0,
        title = "Elevation (m)",
...
# plot map
map4
tmap_save(map4, "Jordan_Elevation.jpg", dpi = 300, height = 10)
