...
# Elevation data is needed to create a hillshade map. The raster package provides an easy access to the SRTM 90 m resolution elevation data with the getData() function. For example, it is possible to download the elevation data for the whole country of "" using the code below: download the elevation data for the whole country of Iraq
alt = getData("alt", country = "Iraq", path = tempdir())
...
#        labels = c("gentle", "moderate", "strong", "very strong", "steep", "extreme"),
    ...
    tm_scale_bar(
        ...
        lwd = 1) +
    tm_compass(
        type = "radar", position=c("left", "top"), size = 10.0) +
# "arrow", "4star", "8star", "radar", "rose"
    tm_layout(scale = .8,
        main.title = "Slope terrain analysis based on DEM of Iraq. Mapping: R",
...
# plot map
map1
tmap_save(map1, "Iraq_Slope.jpg", dpi = 300, height = 10)
...
#        labels = c("gentle", "moderate", "strong", "very strong", "steep", "extreme"),
    ...
    tm_scale_bar(
        ...
        lwd = 1) +
    tm_compass(
        type = "rose", position=c("left", "top"), size = 10.0) +
# "arrow", "4star", "8star", "radar", "rose"
    tm_layout(scale = .8,
        main.title = "Aspect terrain analysis based on DEM of Iraq. Mapping: R",
        main.title.position = "center",
        main.title.color = "black",
        main.title.size = 0.9,
...
# plot map
map2
tmap_save(map2, "Iraq_Aspect.jpg", dpi = 300, height = 10)

Twomaps <- tmap_arrange(map1, map2)
Twomaps
tmap_save(Twomaps, "Iraq_SlopeAspect.jpg", dpi = 300, height = 10, width = 15)
...
# "arrow", "4star", "8star", "radar", "rose"
    tm_layout(scale = .9,
        main.title = "Hillshade terrain analysis based on DEM of Iraq. Mapping: R",
        main.title.position = "center",
        main.title.color = "black",
        main.title.size = 1.0,
...
# plot map
map3
tmap_save(map3, "Iraq_Hillshade.jpg", height = 10)
...
#"classic"  "white", "gray", "natural", "cobalt", "col_blind", "albatross", "beaver", "bw", "watercolor"
    ...
    tm_scale_bar(
        ...
        lwd = 1) +
    tm_compass(
        type = "8star", position=c("left", "top"), size = 10.0) +
# "arrow", "4star", "8star", "radar", "rose"
    tm_layout(scale = .8,
        main.title = "Elevation terrain analysis based on DEM of Iraq. Mapping: R",
        main.title.position = "center",
        main.title.color = "black",
        main.title.size = 1.0,
        title = "Elevation (m)",
...
# plot map
map4
tmap_save(map4, "Iraq_Elevation.jpg", dpi = 300, height = 10)
