...
alt = getData("alt", country = "Serbia", path = tempdir())
...
# "arrow", "4star", "8star", "radar", "rose"
    tm_layout(scale = .8,
        main.title = "Slope terrain analysis based on DEM of Serbia. Mapping: R",
...
# plot map
map1
tmap_save(map1, "Serbia_Slope.jpg", dpi = 300, height = 10)
...
#        labels = c("gentle", "moderate", "strong", "very strong", "steep", "extreme"),
    ...
    tm_scale_bar(
        ...
        lwd = 1) +
    tm_compass(
        type = "rose", position=c("left", "bottom"), size = 10.0) +
# "arrow", "4star", "8star", "radar", "rose"
    tm_layout(scale = .8,
        main.title = "Aspect terrain analysis based on DEM of Serbia. Mapping: R",
        main.title.position = "center",
        main.title.color = "black",
        main.title.size = 0.9,
...
# plot map
map2
tmap_save(map2, "Serbia_Aspect.jpg", dpi = 300, height = 10)
...
# "arrow", "4star", "8star", "radar", "rose"
    tm_layout(scale = .9,
        main.title = "Hillshade terrain analysis based on DEM of Serbia. Mapping: R",
        main.title.position = "center",
        main.title.color = "black",
        main.title.size = 1.0,
...
# plot map
map3
tmap_save(map3, "Serbia_Hillshade.jpg", height = 10)
...
#"classic"  "white", "gray", "natural", "cobalt", "col_blind", "albatross", "beaver", "bw", "watercolor"
    ...
    tm_scale_bar(
        ...
        lwd = 1) +
    tm_compass(
        type = "8star", position=c("left", "bottom"), size = 10.0) +
# "arrow", "4star", "8star", "radar", "rose"
    tm_layout(scale = .8,
        main.title = "Elevation terrain analysis based on DEM of Serbia. Mapping: R",
        main.title.position = "center",
        main.title.color = "black",
        main.title.size = 1.0,
        title = "Elevation (m)",
...
# plot map
map4
tmap_save(map4, "Serbia_Elevation.jpg", dpi = 300, height = 10)
